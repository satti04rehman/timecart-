        ...
        {isTagline ? (
          <>
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-6 sm:flex-row sm:gap-14">
              ...
              <Link
                href="#collection"
                className="group inline-flex items-center gap-3 border-b border-ivory/30 pt-4 pb-3 text-xs font-light uppercase tracking-[0.35em] text-ivory/80 transition-colors hover:border-ivory hover:text-ivory"
              >
                New Arrivals
